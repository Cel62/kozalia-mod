package fr.cel.kozalia.block.container;
...
public class ContainerMineralFurnace extends Container {
    private final IInventory tileFurnace;
    private int cookTime;
    private int totalCookTime;
    private int furnaceBurnTime;
    private int currentItemBurnTime;
    private BlockMineralFurnace.Level level;

    public ContainerMineralFurnace(InventoryPlayer playerInventory, IInventory furnaceInventory, BlockMineralFurnace.Level level) {
        this.level = level;
